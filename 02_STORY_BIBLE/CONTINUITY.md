...
## Canon
Tout ce qui est vrai dans le livre.

| Element | Verite etablie | Source | Notes |
| --- | --- | --- | --- |
| Multivers | Toutes les realites possibles coherentes existent comme branches ou configurations du reel. | Livre 1 | A formuler comme hypothese interne, pas comme preuve scientifique. |
| Branche | Une branche est une trajectoire coherente du reel, vecue localement par une conscience ou partagee collectivement. | Livres 1-3 | La branche n'est pas un simple decor: elle possede coherence, inertie et histoire. |
| Divergence | La distance entre branches peut etre pensee par ecarts observables, de la variation minime a la vie radicalement autre. | Livre 2; METRIQUES_RESONANCE.md | Utiliser `D` avec prudence: mesure interne, non physique. |
| Bifurcation | Une bifurcation durable apparait lorsqu'un ecart, volontaire ou non, modifie les conditions de continuation d'une branche. | Livre 3, chapitre 3 | Distinguer le choix, l'accident et la separation durable qui en resulte. |
...
| Moment | Evenement | Chapitre | Notes |
| --- | --- | --- | --- |
...
| Question | Decision attendue | Urgence |
| --- | --- | --- |
